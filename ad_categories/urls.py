...
urlpatterns = [
    ...
    url(r'(?P<cat_name>[\w\-]+)_region_(?P<region_name>[\w\-]+)/$', AdRegionCategoryView.as_view(), name='ad_category_region'),
    url(r'(?P<cat_name>[\w\-]+)_city_(?P<city_name>[\w\-]+)/$', AdCityCategoryView.as_view(), name='ad_category_city'),
